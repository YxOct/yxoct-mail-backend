...
class MailBackendApplicationTests {
  ...
  void databaseConnectionAndMigrationsAreAvailable() throws Exception {
    ...
    assertThat(queryForInt("SELECT COUNT(*) FROM user_status_audit")).isZero();
  }
  ...
  void openApiDocumentationDescribesMailEndpoints() throws Exception {
    mockMvc
        ...
        .andExpect(jsonPath("$.paths['/api/auth/password'].post").exists())
        ...
        .andExpect(jsonPath("$.paths['/api/admin/mail-accounts/drifts'].get").exists())
        .andExpect(
            jsonPath("$.paths['/api/admin/mail-accounts/{mailAccountId}/retry-provisioning'].post")
                .exists())
        .andExpect(
            jsonPath("$.paths['/api/admin/mail-accounts/{mailAccountId}/repair-drift'].post")
                .exists())
        ...
        .andExpect(jsonPath("$.paths['/api/admin/users/{userId}/password'].post").exists())
        .andExpect(
            jsonPath(
